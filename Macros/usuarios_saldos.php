<?php
	 ...
	 $ConexionCRM->Open();
	 $result=mysql_query("select * from tbl_Usuario_Saldos order by id",$ConexionCRM->cn); 
?>
<html>
<head> 
			...
			<table cellspacing="1" cellpadding="1" border=1; align="center">
				...
				<?$cont=0;while($row = mysql_fetch_assoc($result)){?>
					<tr style="background-color:<?if($cont%2==0){echo "#FFFFFF;";}else{echo "#FFF6A3;";}?>">
						...
						<td><a href="javascript:envia(<?echo $row["id"];?>,14,formulario,1)"><p>Modificar</p></a></td>
						<td><a href="javascript:envia(<?echo $row["id"];?>,15,formulario,1)"><p>Eliminar</p></a></td>
					</tr>
				<?$cont++;}?>
			</table>
		<a href="javascript:envia(0,14,formulario,1)"><p align="center">Nuevo usuario</p></a>
