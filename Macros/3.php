...
<tr>
	...
	<td height=270 class="tdTablas" valign="top">
		...
		<tr>
			...
			<td class="valor" colspan=3><?echo $tbl_Registro["TEL"];?></td>
		</tr>
				<tr><td colspan=4 class="Separador" style="border-bottom:1px solid #CCCCCC;border-top:1px solid #CCCCCC"></td></tr>				
		<tr>
			...
			<td>
				...
				<tr>
					...
					<td class="valorSimple"  style="width:60px;"><?echo $tbl_Registro["MA"];?></td>
				</tr>
				</table>
			</td>
		</tr>
			...
			<td colspan="4">
				...
				<tr>
					...
					<td class="valorSimple"><?echo $tbl_Registro["FORMA_PAGO"];?></td>			
					<td class="campo">No. Contratos:</td>
					<td class="valorSimple"><?echo $tbl_Registro["COI"]?></td>							
				</tr>					
				<tr>
				<tr>
