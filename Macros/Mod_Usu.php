<?php
	  ...
	  $auxid=$_POST["valor"];
	  if($auxid!="0"){
	  	  $result=mysql_query("select * from tbl_Usuario where id='".addslashes($auxid)."'",$ConexionCRM->cn);
...
<body>
	...
	<DIV style="width:900;border: 4px solid #5D5858;background-color:#E0ECF8;">
		...
		<form name="formulario" action="Act_Usu.php?tipo=<?echo($_GET["tipo"]);?>" method="post">
		...
		<a href="usuarios.php?tipo=<?echo($_GET["tipo"]);?>"><p align="center">Regresar</p></a>
	</DIV>
	</TR></TD>
	</TABLE>
</body>
