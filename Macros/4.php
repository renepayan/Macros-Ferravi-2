			...
			<tr>				
				<td align="center">
					...
					<tr>
						...
						<td valign=top align="center"><h2 style="padding:0px;margin-top:2px;margin-bottom:0px;"><?echo $tbl_Campana["Nombre"];?></h2></td>
					</tr>
					</table>
				</td>
			</tr>
	...
	<td height=270 class="tdTablas" valign="top">
		...
		<tr>
			<td colspan="4">
				...
				<tr>
					<td class="campo" colspan="1">TELEFONO 4:</td>
					<td width="195" colspan="3"><?echo $tbl_Registro["consolidadado_chrge_off_CHARAL_lay3_TELEFONO"];?></td>									
				</tr>	
				<tr>
 		...
 		<tr>
			<td colspan="4">
				...
				<tr>
					...
					<td width="195" ><?echo $tbl_Registro["OTRA_CUENTA"];?></td>										
					<td class="campo">CUENTA TRANSCODIFICADA:</td>
					<td width="195" ><?echo $tbl_Registro["CUENTA_TRANSCODIFICADA"];?></td>	
				</tr>				
				</table>
			</td>
		</tr> 			
		<tr>
		<td width="80" class="campo">CUENTA:</td>
			<td>
				<table cellspacing=0 cellpadding=0 >
				<tr>				
					...
					<td class="campoSimple"  style="width:40px;">Descuento:</td>
...
<tr>
			<td colspan="4">
				...
				<tr>
					...
					<td class="valorSimple"><?echo $tbl_Registro["SALDO_ACTUAL"];?></td>
				...
				<tr>
					...
					<td class="campo">SALDO CON DESCUENTO:</td>
	...
	<td class="tdTablas"  valign="top" width=100 nowrap rowspan=3>
		...
		<tr>
			<td>
				<form name="oculto">
					<input type="button" id="bmP1" value="Mostrar Referencias Personales" onclick="muestra('P1')">
					<input type="button" id="boP1" value="Ocultar Referencias Personales" onclick="oculta('P1')" style="display:none;">
					<input type="button" id="bmP2" value="Mostrar Datos de facturaci&oacute;n" onclick="muestra('P2')">
					<input type="button" id="boP2" value="Ocultar Datos de facturaci&oacute;n" onclick="oculta('P2')" style="display:none;">
				</form>
			</td>
		</tr>		
		<tr>
		...
		<tr valign="top">
			...
			<td valign="top">	
				<select name="Cve_Gestion" size=1>
								...
								<option value="17" >&nbsp;CP -  CONFIRMACIÓN DE PAGO</option>
								<option value="18" >&nbsp;AC -  ACLARACIÓN</option>
								<option value="19" >&nbsp;NE -  NEGATIVA DE PAGO</option>
								<option value="20" >&nbsp;PP -  PROMESA DE PAGO PARCIAL</option>
								<option value="21" >&nbsp;ST -  PROMESA DE PAGO POR SALDO TOTAL CON INTENCIÓN DE CANCELACIÓN</option>
								<option value="22" >&nbsp;PB -  PROMESA DE PAGO CON QUITA DE 40 DÍAS</option>
								<option value="23" >&nbsp;SP -  SEGUIMIENTO DE PROMESA</option>
								<option value="24" >&nbsp;PR -  CONFIRMACIÓN DE PAGO</option>
								<option value="25" >&nbsp;CR -  SOLICITA INFORMACIÓN</option>
								<option value="26" >&nbsp;PT -  PROMESA DE PAGO QUITA 4 MESES</option>
								<option value="27" >&nbsp;DE -  DEFUNCIÓN</option>
								<option value="28" >&nbsp;CS -  MENSAJE CON CONOCIDO</option>
								<option value="29" >&nbsp;RR -  MENSAJE CON FAMILIAR</option>
								<option value="30" >&nbsp;DC -  MENSAJE CON CONTESTADORA DE CASA</option>
								<option value="31" >&nbsp;CC -  MENSAJE EN CONTESTADORA DE CELULAR</option>
								<option value="32" >&nbsp;RS -  MENSAJE EN CONTESTADORA DE OFICINA</option>
								<option value="33" >&nbsp;NI -  NO VIVE AHÍ PERO ES CASA DE FAMILIAR</option>
								<option value="34" >&nbsp;FA -  FUERA DE SERVICIO</option>
								<option value="35" >&nbsp;IL -  ILOCALIZABLE</option>
								<option value="36" >&nbsp;NC -  NO CONTESTAN</option>
								<option value="37" >&nbsp;EQ -  NO VIVE AHÍ NO LO CONOCEN</option>
								<option value="38" >&nbsp;LIQ -  LIQUIDADA</option>
								<option value="39" >&nbsp;OD -  OTRO DATO</option>
