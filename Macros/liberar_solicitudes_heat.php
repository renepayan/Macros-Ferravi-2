...
<head> 
	<meta charset="UTF-8">
        <title>Liberar Solicitudes HEAT</title>
        <script>
            function magia(){
...
<body>
	...
	<DIV style="width:900;border: 4px solid #5D5858;background-color:#E0ECF8;">
                <H2 align="center"><FONT COLOR="BLUE"><B><I>Importar Solicitudes a Liberar</I></B></FONT></H2>
		<P align="center">
                <form name="formulario" align="center" method="post" action="imp_liberar_solicitudes_heat.php" onsubmit='document.getElementById("carga").style.display = "inline";document.getElementById("enviar").disabled = true;' enctype="multipart/form-data">
