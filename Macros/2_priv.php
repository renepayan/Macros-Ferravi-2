...
<form name="frm" method="post" action="bin.php" style="margin:0px;">
<input type="hidden" name="idRegistro" value="<?php echo $_POST["valor"]?>"> 
...
<td width="80" class="campo"></td>
		...
		<tr>
			<td class="campo"">Teléfono 1:</td>
			<td class="valor" colspan=3><?echo $tbl_Registro["TELEFONO"];?></td>
		</tr>
