		...
		<tr>
			...
			<tr>				
				<td align="center">
					...
					<tr>
						<td style="color:#FFFFFF" align="center">Esta llamada proviene del Ciclo: </td>						
					</tr><tr>
						<td valign=top align="center"><h2 style="padding:0px;margin-top:2px;margin-bottom:0px;"><?echo $tbl_Registro["CICLO"];?></h2></td>
					</tr>
					</table>
				</td>
			</tr>
...
<tr style="background-color:<?echo $tbl_Campana_Colores["Fondo"];?>">
	<td class="tdTablas">
		...
		<tr valign="top">
			<td valign="top" align="right" style="background-color:<?echo $tbl_Campana_Colores["Fondo"];?> class="campoResult">Motivo de no pago</td>
			<td valign="top">	
				<select name="MNP" size=1>
								<?php
									$file=fopen("mnp_".$_GET["tipo"], "r");
									while(!feof($file)){
										$value=preg_replace ("[\n|\r|\n\r]","",fgets($file));
										$clave=preg_replace ("[\n|\r|\n\r]","",fgets($file));
										$descripcion=preg_replace ("[\n|\r|\n\r]","",fgets($file));
